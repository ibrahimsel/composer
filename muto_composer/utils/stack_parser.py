...
class StackParser:
    ...
    def _try_direct_stack_json(self, payload: dict[str, Any]) -> dict[str, Any] | None:
        """
    ...
    def _try_archive_format(self, payload: dict[str, Any]) -> dict[str, Any] | None:
        """
    ...
    def _try_solution_manifest(self, payload: dict[str, Any]) -> dict[str, Any] | None:
        """
    ...
    def _decode_base64_stack(self, data_b64: str) -> dict[str, Any] | None:
        """
...
def create_stack_parser(logger: logging.Logger | None = None) -> StackParser:
    """
