...
<<<<<<< Updated upstream
    ...
    @patch("composer.compose_plugin.ComposePlugin")
=======
    # @patch("composer.plugins.compose_plugin.MutoDefaultComposePlugin.publish_composed_stack")
...
=======
    # @patch("composer.plugins.compose_plugin.LocalMode")
    # @patch("composer.plugins.compose_plugin.RepoMode")
    # @patch("composer.plugins.compose_plugin.NativeMode")
