...
from muto_composer.events import EventBus, EventType, StackAnalyzedEvent, StackRequestEvent
...
class TestStackRequestEventValidation(unittest.TestCase):
    ...
    def test_stack_request_creation(self):
        ...
        self.assertEqual(json_stack_event.stack_payload["metadata"]["content_type"], "stack/json")
        ...
        self.assertEqual(
            archive_stack_event.stack_payload["metadata"]["content_type"], "stack/archive"
        )
