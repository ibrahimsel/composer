...
class PipelineStartedEvent(BaseComposeEvent):
    ...
    def __init__(
        ...
        pipeline_name: str,
        execution_id: str,
        steps_planned: Optional[List[str]] = None,
        **kwargs,
    ):
        super().__init__(
            event_type=event_type,
...
class StackProcessedEvent(BaseComposeEvent):
    ...
    def __init__(
        ...
        processing_applied: Optional[list] = None,
        **kwargs,
    ):
        super().__init__(
...
class PipelineEvents:
    ...
    def create_completion_event(
        pipeline_name: str, success: bool = True, result: Optional[Dict[str, Any]] = None
    ):
    ...
    def create_error_event(
        pipeline_name: str, error: str, context: Optional[Dict[str, Any]] = None
    ):
